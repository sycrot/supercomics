...
import { getEvents, getEventsOfListIds } from "@/services/marvel"
          ...
          <div className="mt-20 md:mt-28 comics-section">
            ...
            <div className="mt-10">
              <div className="flex flex-wrap gap-3">
                {events.slice(25 * (+routerParams.currentPage - 1), 25 * +routerParams.currentPage).map((item: TEvent) => (
              ...
              <Flowbite theme={{ theme: customTheme }} >
                <Pagination currentPage={+routerParams.currentPage} totalPages={Math.ceil(events.length / 25)} onPageChange={onPageChange} showIcons />
              </Flowbite>
            </div>
          </div>
          :
